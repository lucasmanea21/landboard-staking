      ...
      <div className="stake-container">
        ...
        <div className="home__form" onSubmit={() => {}}>
              ...
              <LabelButton
                onClick={() =>
                  handleChangeStakedQuantity({
                    target: {
                      value:
                        totalLandBalance < 10000 ? totalLandBalance : 10000,
                    },
                  })
                }
              />
          ...
          <div className="home__form--info">
            ...
            <span>
              There will be a 9 - 10 days unbonding period when you unstake. You
              will be able to withdraw your funds only after that period.
            </span>
          </div>
